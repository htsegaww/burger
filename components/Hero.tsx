...
const Hero = () => {
  ...
  return (
    <div className="flex md:gap-[300px]  h-full flex-col md:flex-row justify-between w-full mt-10">
      ...
      <div className="flex flex-col w-[400px] items-center mr-28 gap-y-10">
        <Image
          src="/burger.png"
          alt=""
          width={820}
        ...
        />
        <Star fill="#c53c2d" size={50} className="transform rotate-180 " />
        <p className="text-5xl md:text-3xl font-bold text-center w-full">
